...
import {HistoryType, FilmsType, FilmType, MatchType} from '../../interface/types';
import {Operation as FilmsOperation} from '../../reducer/films/films.js';
import {getLoading, getFilms} from '../../reducer/films/selectors';
import {getError} from '../../reducer/films/selectors';
